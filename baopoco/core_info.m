...
% baopoco/adc_capture
baopoco_adc_capture_type         = 'xps_sw_reg';
baopoco_adc_capture_param        = 'in';
baopoco_adc_capture_ip_name      = 'opb_register_ppc2simulink';
baopoco_adc_capture_addr_start   = hex2dec('01000200');
baopoco_adc_capture_addr_end     = hex2dec('010002FF');

% baopoco/adc_sum0
baopoco_adc_sum0_type         = 'xps_sw_reg';
baopoco_adc_sum0_param        = 'out';
baopoco_adc_sum0_ip_name      = 'opb_register_simulink2ppc';
baopoco_adc_sum0_addr_start   = hex2dec('01000300');
baopoco_adc_sum0_addr_end     = hex2dec('010003FF');

% baopoco/adc_sum1
baopoco_adc_sum1_type         = 'xps_sw_reg';
baopoco_adc_sum1_param        = 'out';
baopoco_adc_sum1_ip_name      = 'opb_register_simulink2ppc';
baopoco_adc_sum1_addr_start   = hex2dec('01000400');
baopoco_adc_sum1_addr_end     = hex2dec('010004FF');

% baopoco/adc_sum2
baopoco_adc_sum2_type         = 'xps_sw_reg';
baopoco_adc_sum2_param        = 'out';
baopoco_adc_sum2_ip_name      = 'opb_register_simulink2ppc';
baopoco_adc_sum2_addr_start   = hex2dec('01000500');
baopoco_adc_sum2_addr_end     = hex2dec('010005FF');

% baopoco/adc_sum3
baopoco_adc_sum3_type         = 'xps_sw_reg';
baopoco_adc_sum3_param        = 'out';
baopoco_adc_sum3_ip_name      = 'opb_register_simulink2ppc';
baopoco_adc_sum3_addr_start   = hex2dec('01000600');
baopoco_adc_sum3_addr_end     = hex2dec('010006FF');

% baopoco/adc_sum_sq0
baopoco_adc_sum_sq0_type         = 'xps_sw_reg';
baopoco_adc_sum_sq0_param        = 'out';
baopoco_adc_sum_sq0_ip_name      = 'opb_register_simulink2ppc';
baopoco_adc_sum_sq0_addr_start   = hex2dec('01000700');
baopoco_adc_sum_sq0_addr_end     = hex2dec('010007FF');

% baopoco/adc_sum_sq1
baopoco_adc_sum_sq1_type         = 'xps_sw_reg';
baopoco_adc_sum_sq1_param        = 'out';
baopoco_adc_sum_sq1_ip_name      = 'opb_register_simulink2ppc';
baopoco_adc_sum_sq1_addr_start   = hex2dec('01000800');
baopoco_adc_sum_sq1_addr_end     = hex2dec('010008FF');

% baopoco/adc_sum_sq2
baopoco_adc_sum_sq2_type         = 'xps_sw_reg';
baopoco_adc_sum_sq2_param        = 'out';
baopoco_adc_sum_sq2_ip_name      = 'opb_register_simulink2ppc';
baopoco_adc_sum_sq2_addr_start   = hex2dec('01000900');
baopoco_adc_sum_sq2_addr_end     = hex2dec('010009FF');

% baopoco/adc_sum_sq3
baopoco_adc_sum_sq3_type         = 'xps_sw_reg';
baopoco_adc_sum_sq3_param        = 'out';
baopoco_adc_sum_sq3_ip_name      = 'opb_register_simulink2ppc';
baopoco_adc_sum_sq3_addr_start   = hex2dec('01000A00');
baopoco_adc_sum_sq3_addr_end     = hex2dec('01000AFF');

% baopoco/ctrl
baopoco_ctrl_type         = 'xps_sw_reg';
baopoco_ctrl_param        = 'in';
baopoco_ctrl_ip_name      = 'opb_register_ppc2simulink';
baopoco_ctrl_addr_start   = hex2dec('01000B00');
baopoco_ctrl_addr_end     = hex2dec('01000BFF');
...
baopoco_delay_delay_data_addr_start   = hex2dec('01000C00');
baopoco_delay_delay_data_addr_end     = hex2dec('01000CFF');
...
baopoco_dir_x1_ab_imag_addr_start   = hex2dec('01080000');
baopoco_dir_x1_ab_imag_addr_end     = hex2dec('01080FFF');
...
baopoco_dir_x1_ab_real_addr_start   = hex2dec('01081000');
baopoco_dir_x1_ab_real_addr_end     = hex2dec('01081FFF');
...
baopoco_dir_x1_ac_imag_addr_start   = hex2dec('01082000');
baopoco_dir_x1_ac_imag_addr_end     = hex2dec('01082FFF');
...
baopoco_dir_x1_ac_real_addr_start   = hex2dec('01083000');
baopoco_dir_x1_ac_real_addr_end     = hex2dec('01083FFF');
...
baopoco_dir_x1_ad_imag_addr_start   = hex2dec('01084000');
baopoco_dir_x1_ad_imag_addr_end     = hex2dec('01084FFF');
...
baopoco_dir_x1_ad_real_addr_start   = hex2dec('01085000');
baopoco_dir_x1_ad_real_addr_end     = hex2dec('01085FFF');
...
baopoco_dir_x1_bb_real_addr_start   = hex2dec('01086000');
baopoco_dir_x1_bb_real_addr_end     = hex2dec('01086FFF');
...
baopoco_dir_x1_bc_imag_addr_start   = hex2dec('01087000');
baopoco_dir_x1_bc_imag_addr_end     = hex2dec('01087FFF');
...
baopoco_dir_x1_bc_real_addr_start   = hex2dec('01088000');
baopoco_dir_x1_bc_real_addr_end     = hex2dec('01088FFF');
...
baopoco_dir_x1_bd_imag_addr_start   = hex2dec('01089000');
baopoco_dir_x1_bd_imag_addr_end     = hex2dec('01089FFF');
...
baopoco_dir_x1_bd_real_addr_start   = hex2dec('0108A000');
baopoco_dir_x1_bd_real_addr_end     = hex2dec('0108AFFF');
...
baopoco_dir_x1_cc_real_addr_start   = hex2dec('0108B000');
baopoco_dir_x1_cc_real_addr_end     = hex2dec('0108BFFF');
...
baopoco_dir_x1_cd_imag_addr_start   = hex2dec('0108C000');
baopoco_dir_x1_cd_imag_addr_end     = hex2dec('0108CFFF');
...
baopoco_dir_x1_cd_real_addr_start   = hex2dec('0108D000');
baopoco_dir_x1_cd_real_addr_end     = hex2dec('0108DFFF');
...
baopoco_dir_x1_dd_real_addr_start   = hex2dec('0108E000');
baopoco_dir_x1_dd_real_addr_end     = hex2dec('0108EFFF');

% baopoco/fft_shift
baopoco_fft_shift_type         = 'xps_sw_reg';
baopoco_fft_shift_param        = 'in';
baopoco_fft_shift_ip_name      = 'opb_register_ppc2simulink';
baopoco_fft_shift_addr_start   = hex2dec('0108F000');
baopoco_fft_shift_addr_end     = hex2dec('0108F0FF');
...
baopoco_insel_insel_data_addr_start   = hex2dec('0108F100');
baopoco_insel_insel_data_addr_end     = hex2dec('0108F1FF');
...
baopoco_seed_seed_data_addr_start   = hex2dec('0108FA00');
baopoco_seed_seed_data_addr_end     = hex2dec('0108FAFF');

% baopoco/status
baopoco_status_type         = 'xps_sw_reg';
baopoco_status_param        = 'out';
baopoco_status_ip_name      = 'opb_register_simulink2ppc';
baopoco_status_addr_start   = hex2dec('0108FB00');
baopoco_status_addr_end     = hex2dec('0108FBFF');
