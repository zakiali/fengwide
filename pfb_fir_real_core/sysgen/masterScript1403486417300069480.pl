...
$ENV{'SYSGEN'} = '/scratch/Xilinx/13.3/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => '/tmp/sysgentmp-zaki/cg_wk/c0c01c86d7fc20c35',
    ...
    'design_full_path' => '/scratch/zaki/workspace/baobab/pfb_fir_real_core.mdl',
    'device' => 'xc5vsx95t-1ff1136',
    'device_speed' => '-1',
    'directory' => '/scratch/zaki/workspace/baobab/pfb_fir_real_core',
    'dsp_cache_root_path' => '/tmp/sysgentmp-zaki',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => '/scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => '/scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
    'generateUsing71FrontEnd' => 1,
    'generating_island_subsystem_handle' => 61081.000244140625,
    'generating_subsystem_handle' => 61081.000244140625,
    ...
    'isdeployed' => 0,
    'ise_version' => '13.3i',
    'master_sysgen_token_handle' => 61082.00012207031,
    'matlab' => '/scratch/mathworks/R2010a',
    'matlab_fixedpoint' => 1.0,
    'mdlHandle' => 61081.000244140625,
    'mdlPath' => '/scratch/zaki/workspace/baobab/pfb_fir_real_core.mdl',
    'modelDiagnostics' => [
      {
        'count' => 598.0,
        'isMask' => 0.0,
    ...
    'model_path' => '/scratch/zaki/workspace/baobab/pfb_fir_real_core.mdl',
    ...
    'sg_version' => '',
    'simulation_island_subsystem_handle' => 61081.000244140625,
    ...
    'tempdir' => '/tmp',
    'testbench' => 0,
    'tmpDir' => '/scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen',
    'trim_vbits' => 1.0,
    'use_strict_names' => 1,
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'b6ed642f3d28b22bc197702c8501382e',
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'dfbf55be046d902055136f1a2f9e76e4',
    'sourceFile' => '/scratch/Xilinx/13.3/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = [
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '2500508a01e72518f6619be6efce3369',
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '208c4e6423b275b940602bb7695d8c8a',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'e5890ec79bdd0bf97b3ff4c757aec693',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '1b708656712109bb2558a38138d7b562',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'cf12d67aaf1e47c7c2ca26256c53228a',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '60e3750e1619b4d7b24a25842817ff3b',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '2aa40224828796615a288ec0e6f86419',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '3c6c8da5147aa27ab29d7d772ea58495',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '799dfd6db0dadf5c98974d1fe4b1ee74',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'df1aa178367b21df8dc0eb56363d9767',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ebc7888178814eb98cdf0cbad783721c',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'd51c863168faa4c64b78ed650fd2bdec',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'a0aadd480a3a8cc502fd2dbcc60c9ee2',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '7f5d2c20529fbfa5cf1097d1fa2899a3',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '675a3f004964c6c0c5efc3060888ea36',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
...
',
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '4d454535acf6dbbfd9331d89392ee0a9',
    'sourceFile' => 'hdl/xlsprom.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      addra: in std_logic_vector(c_address_width - 1 downto 0);
      clka: in std_logic;
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'c21552d73203eb405797bb5b6ae73b3e',
...
begin
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = '/scratch/Xilinx/13.3/ISE_DS/ISE/sysgen';
  open(RESULTS, '> /scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen/script_results4673107162031691286') || 
    croak 'couldn\'t open /scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen/script_results4673107162031691286';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing /scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen/script_results4673107162031691286';
};
