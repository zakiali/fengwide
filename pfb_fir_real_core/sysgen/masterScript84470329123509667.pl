...
$ENV{'SYSGEN'} = '/scratch/Xilinx/13.3/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'coregen_core_generation_tmpdir' => '/tmp/sysgentmp-zaki/cg_wk/cb2748cc2fe8a0ea6',
    ...
    'generating_island_subsystem_handle' => 87631.00476074219,
    'generating_subsystem_handle' => 87631.00476074219,
    ...
    'isdeployed' => 0,
    'ise_version' => '13.3i',
    'master_sysgen_token_handle' => 87633.48486328125,
    'matlab' => '/scratch/mathworks/R2010a',
    'matlab_fixedpoint' => 1.0,
    'mdlHandle' => 87631.00476074219,
    ...
    'sg_version' => '',
    'simulation_island_subsystem_handle' => 87631.00476074219,
...
begin
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = '/scratch/Xilinx/13.3/ISE_DS/ISE/sysgen';
  open(RESULTS, '> /scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen/script_results4430386312719024084') || 
    croak 'couldn\'t open /scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen/script_results4430386312719024084';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing /scratch/zaki/workspace/baobab/pfb_fir_real_core/sysgen/script_results4430386312719024084';
};
