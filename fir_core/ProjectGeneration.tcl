#
# Created by System Generator     Sun May 20 23:43:25 2012
#
...
namespace eval ::xilinx::dsptool::iseproject::param {
    ...
    set NewXSTParser {0}
    set ProjectFiles {
        {{fir_core_cw.vhd} -view All}
        {{fir_core.vhd} -view All}
        {{fir_core_cw.ucf}}
        ...
        {{/scratch/zaki/workspace/baobab/fir_core.mdl}}
    }
    set TopLevelModule {fir_core_cw}
    set SynthesisConstraintsFile {fir_core_cw.xcf}
